...
def search_cards():
    search_name = easygui.enterbox("Enter the name of the Monster you would "
                                   "like to find", "Monster Card "
                                                   "Searcher").capitalize()
    if search_name in monster_cards:
        easygui.msgbox(f"{search_name} is a Monster Card currently in the "
                       f"dictionary", "Monster Card Searcher")
    else:
        easygui.msgbox(f"{search_name} is not currently in the dictionary",
                       "Monster Card Searcher")
